...
\setlist[itemize]{leftmargin=*, itemsep=-15pt}
...
\begin{titlepage}
    ...
    \textbf{\droidFont \fontsize{18}{1}\selectfont Introducción a la Ingeniería Electrónica / Introducción a la Bioingeniería}
...
Este número se puede encontrar en el SIU Guaraní FIUBA, en todos los comprobantes de inscripción a materias, finales u otras solicitudes.
También aparece en el pdf que se descarga al bajar el plan de estudios desde SIU Guaraní (sí, así de antiintuitivo) y en el certificado de alumno regular.
...
\begin{itemize}
    \item Dr. Ricardo Gelpi: es el rector actual de la Universidad de Buenos Aires. Es la máxima autoridad académica de la UBA. Es médico.
    \item Ing. Alejandro Martínez: es el decano de la Facultad de Ingeniería de la Universidad de Buenos Aires. Es la máxima autoridad académica de FIUBA. Es Ingeniero en Electrónica, especializado en Telecomunicaciones. 
    \item Ing. Ricardo Veiga: es el director de la carrera de Ingeniería Electrónica. 
    \item Sergio Lew: es el director de la carrera de Bioingeniería.
\end{itemize}
% subsection  (end)
...
Para saber dónde están los departamentos, visita esa sección. % TODO agregar link a la seccion
...
\subsection{Todo sobre el LABI, el epicentro de la electrónica}\label{sub:todo_sobre_el_labi_el_epicentro_de_la_electronica} % (fold)
...
También es donde se llevan a cabo varios de los clubes de la facultad, como el Club de Robótica o el de Radiofrecuencias, y donde está la bandera de IEEE.
...
Pueden ver más en su Instagram: @bilab.fiuba
% subsection Todo sobre el BILAB, el nucleo de la bioingenieria (end)

\subsection{Los clubes de la FIUBA: el verdadero aprendizaje basado en proyectos }\label{sub:los_clubes_de_la_fiuba_el_verdadero_aprendizaje_basado_en_proyectos_} % (fold)
...
Pueden ver un poco más de lo que hacen en su Instagram: @cdr.fiuba.
Se juntan los viernes de 19 a 22hs en el LABi.
...
Pueden ver un poco más de lo que hacen en su Instagram: @rf\_fiuba.
...
Pueden ver un poco más de lo que hacen en su Instagram: @fiubaracing
...
Pueden ver un poco más de lo que hacen en su Instagram: @astar\_aeroespacial
% subsubsection ASTAR (end)

% subsection Los clubes de la FIUBA: el verdadero aprendizaje basado en proyectos  (end)


\subsection{La rama estudiantil IEEE UBA}\label{sub:la_rama_estudiantil_ieee_uba} % (fold)
...
Organizan la ExpoClubes, donde los distintos clubes de la FIUBA presentan sus avances y proyectos para que otros alumnos puedan conocer sus propuestas y sumarse al desarrollo que se realiza en la facultad para complementar lo aprendido en las aulas.
...
Para más información pueden visitar el Instagram de la rama y sumarse a la Comunidad de WhatsApp
% subsection La rama estudiantil IEEE UBA (end)


\subsection{Departamentos de la facultad: la magia de la cartelera}\label{sub:departamentos_de_la_facultad_la_magia_de_la_cartelera} % (fold)
...
Primer piso, a la izquierda. El mail es matem@fi.uba.ar. Las materias de este departamento que se encuentran en los planes de estudio de electrónica o bioingeniería son Álgebra II, Análisis Matemático II, Probabilidad y Estadística, y Análisis Matemático III (obligatoria en plan viejo). 
...
Segundo piso, a la derecha. El mail es fisica@fi.uba.ar. Las materias de este departamento que se encuentran en el plan de estudio de electrónica y bioingeniería son Física de los Sistemas de Partículas, y Electricidad, Magnetismo y Calor; y para bioingeniería se suma Física de Sólidos y Nuclear. 
...
Planta baja, a la derecha. Igual no te van a abrir la puerta. Manda directo un mail a admision@fi.uba.ar y ahorrate diez minutos de tu vida. La mayoría de las cosas para las que uno iría al departamento de alumnos en realidad las gestiona Tramitaciones, y el mail de ellos es tramitaciones@fi.uba.ar. 
...
Cuarto piso, a la derecha. El mail es computacion@fi.uba.ar. Las materias del departamento que se encuentran en los planes de estudio de electrónica o bioingeniería son Algoritmos y Programación y Análisis Numérico (obligatoria en el plan viejo). 
...
En Las Heras, primer piso a la derecha. El mail es economia@fi.uba.ar.
...
En PC, cuarto piso a la derecha. El mail es diat@fi.uba.ar.
...
Por lo general les van a pedir que manden un mail a laboratoriolci@gmail.com, donde el mensaje automático les explicará qué enviar.
...
\begin{itemize}
  \item Mostaza de Puerto Madero.
  \item La parri. (atrás de la Shell, más para la noche se pone mejor).
  \item Mango Express. (Comida por peso)
  \item Food Express. (Comida por peso)
\end{itemize}
...
Sí se considera aplazo desaprobar el final al menos una vez y volverse a anotar a la cursada, o desaprobar las 3 veces que uno se presentó al final de la materia (para más información de cuándo aplica el aplazo, ver esta sección).
...
Ahora, hay materias que pueden aceptar una excepción de correlatividad si al alumno le falta rendir el final de la materia correlativa.
Eso depende principalmente de que los temas asociados a la instancia de evaluación final no sean esenciales para la cursada de la materia siguiente; y no se dará cuando los temas del final sean esenciales para comprender la cursada de la materia para la cual se pide la excepción.
Esto se recomienda consultarlo previamente a anotarse con el docente de la materia de la cual se quiere pedir la excepción de correlatividad, ya sea buscando el correo en la página de cátedra de la materia en cuestión o acercándose a alguna fecha de final a consultar.

De aprobar el docente la excepción de correlatividad, el alumno deberá descargar el pedido de excepción de correlatividad en la página oficial de formularios de FIUBA, hacerlo firmar por el profesor adjunto de la materia y llevarlo al Departamento de Electrónica, donde el director de la carrera lo firmará.
...
Es esencial recordar que no se debe rendir el final de la materia hasta haber aprobado el final de su correlativa.
Si uno por ejemplo aprueba la cursada de Análisis de Circuitos y pide la excepción de correlatividad para cursar Electromagnetismo Aplicado, se debe rendir primero el final de Análisis de Circuitos y luego el de Electromagnetismo Aplicado.
...
Se recomienda llevarlo impreso (hay un modelo en el sitio de formularios de FIUBA, pero es mucho más estético y ampliamente utilizado el que se ofrece en el Campus Grado), pero también se puede pedir uno en el Departamento de Electrónica.
...
La presentación dura todo el año para el cual se presenta, e implica mejoras en la prioridad.
...
\subsection{Como se calcula la prioridad?}\label{sub:como_se_calcula_la_prioridad_} % (fold)
...
\subsection{Que es un aplazo y en que casos alica?}\label{sub:que_es_un_aplazo_y_en_que_casos_alica_} % (fold)
...
\end{itemize}
% subsection Que es un aplazo y en que casos alica? (end)
...
\end{figure}
Luego de acceder al SIU Guaraní FIUBA, en la solapa de “Reportes” seleccionar “Oferta de comisiones” para poder acceder a la oferta horaria.
...
Sin iniciar sesión en el SIU Guaraní FIUBA, en lugar de entrar a la cuenta en la solapa de “Acceso,” clickear la solapa de “Fechas de Examen.
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1 \textwidth]{fechas_examen}
    \label{fig:fechas_examen}
\end{figure}
% subsection Como puedo ver todas las fechas de examen de una tanda? (end)


\subsection{Como obtengo el certificado de alumno regular?}\label{sub:como_obtengo_el_certificado_de_alumno_regular_} % (fold)
\begin{wrapfigure}{r}{0.3\textwidth} %this figure will be at the right
    \centering
    \includegraphics[width=0.3\textwidth]{tramites}
\end{wrapfigure}
Iniciando sesión en el SIU Guaraní FIUBA, en la solapa de “Trámites” seleccione la opción de “Solicitar Constancias y Certificados.”
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.8 \textwidth]{constancia}
...
El proceso es idéntico al de la obtención del Certificado de Alumno Regular, con la distinción de que en “Constancia:” se debe solicitar el “Analítico Parcial” como se muestra en la siguiente imagen.
Luego de iniciar la descarga (haciendo click en el ícono de pdf), se debe esperar 10 minutos sin cerrar la pestaña.
Nótese que éste no es el analítico parcial que se solicita para los intercambios, y que ese otro debe obtenerse desde Tramitaciones.
...
Por si se requiere material adicional, hoy en día casi todo está en el FIUBA-Verse, pero también existen Comunidad FIUBA y los Drives gestionado por alumnos que armó el Espacio Estudiantil FIUBA.
...
Hoy en día para obtener información sobre las distintas cátedras de una misma materia se utiliza FIUBA Reviews, pero está bastante incompleto.
...
La mayoría de los fiubenses usan el famoso FIUBA MAP (cortesía de Federico del Mazo) para obtener un grafo muy lindo con las correlativas de las materias.
...
Como explicamos en la sección del LABi, se ofrecen cursos de soldadura a mediados de cada cuatrimestre como actividades complementarias de Introducción a la Ingeniería Electrónica / Introducción a la Bioingeniería.
...
\begin{itemize}
    ...
    \item Overleaf: Ideal para redacción de trabajos prácticos en entorno LaTeX: se vincula a continuación una plantilla ampliamente utiliza en el entorno de FIUBA.
\end{itemize}
